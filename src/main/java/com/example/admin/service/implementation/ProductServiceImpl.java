...
public class ProductServiceImpl implements ProductService {
    ...
    public String saveSubProduct (ExtraDtoResponse productRequest) {
        SubCategoryDocument response =subCategoryRepository.findByName("Industrial Supplies");
        for(ProductCategoryRequest pro:productRequest.getProductCategoryRequestList()) {
//            ProductCategoryDocument subCat = new ProductCategoryDocument();
//            subCat.setName(pro.getListing());
//            subCat.setParentId(response.getId());
//            subCat.setContent(pro.getDescription());
